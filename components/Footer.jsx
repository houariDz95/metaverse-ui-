  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      ...
      <div className="flex flex-col">
        <div className="mb-[5px] h-[2px] bg-white opacity-10" />
        <div className="flex items-center justify-between flex-wrap gap-4">
          <h4 className="font-extrabold text-[24px] text-white">Metaverse</h4>
          <p className="text-white font-normal text-[14px] opacity-50">Copyright © 2021 - 2022 Metaversus. All rights reserved.</p>
